...
def get_thumb(name):
    url = f"https://github.com/Tgsbb_b/CatUserbot-Resources/blob/master/Resources/Inline/{name}?raw=true"
...
async def article_builder(event, method):
    ...
    if method == "ls":
        ...
        media = "https://github.com/Tgsbb_b/CatUserbot-Resources/raw/master/Resources/Inline/filemanager.jpg"
    elif method == "deploy":
        media = "https://github.com/Tgsbb_b/CatUserbot-Resources/raw/master/Resources/Inline/catlogo.png"
        title = "𝘾𝙖𝙩𝙐𝙨𝙚𝙧𝙗𝙤𝙩"
        description = "Deploy yourself."
        query = "𝗗𝗲𝗽𝗹𝗼𝘆 𝘆𝗼𝘂𝗿 𝗼𝘄𝗻 𝗖𝗮𝘁𝗨𝘀𝗲𝗿𝗯𝗼𝘁."
        buttons = [
            (
                Button.url("Source code", "https://github.com/Tgsbb_b/catuserbot"),
                Button.url("Deploy", "https://github.com/Tgsbb_b/nekopack"),
            )
        ]
        ...
        buttons = [
            (
                ...
                Button.url("Repo", "https://github.com/Tgsbb_b/catuserbot"),
            )
        ]
        try:
        ...
        try:
            ...
            media = "https://github.com/Tgsbb_b/CatUserbot-Resources/raw/master/Resources/Inline/spotify_off.png"
            if (
