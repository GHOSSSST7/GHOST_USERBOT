...
from sbb_b.utils import admin_cmd, edit_or_reply
...
@sbb_b.on(admin_cmd(pattern="weeb ?(.*)"))
...
@sbb_b.on(admin_cmd(pattern="tantext ?(.*)"))
...
@sbb_b.on(admin_cmd(pattern="linetext ?(.*)"))
...
@sbb_b.on(admin_cmd(pattern="boxtext ?(.*)"))
...
@sbb_b.on(admin_cmd(pattern="bubbletext ?(.*)"))
