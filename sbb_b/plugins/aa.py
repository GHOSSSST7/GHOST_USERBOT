...
from sbb_b.sql_helper.greetings_db import (
    add_goodbye,
    add_thanks,
    add_welcome,
    delete_goodbye,
...
@sbb_b.ar_cmd(pattern="setwelcome", groups_only=True)
...
@sbb_b.ar_cmd(pattern="clearwelcome$", groups_only=True)
...
@sbb_b.ar_cmd(pattern="getwelcome$", groups_only=True)
...
@sbb_b.ar_cmd(pattern="setgoodbye", groups_only=True)
...
@sbb_b.ar_cmd(pattern="cleargoodbye$", groups_only=True)
...
@sbb_b.ar_cmd(pattern="getgoodbye$", groups_only=True)
...
@sbb_b.ar_cmd(pattern="thankmembers (on|off)", groups_only=True)
